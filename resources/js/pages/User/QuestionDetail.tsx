        ...
        <>
            ...
            <div className="flex flex-col gap-6 p-6 max-w-7xl mx-auto w-full">
                <div className="mb-2 flex justify-between items-center bg-card p-3 rounded-2xl border shadow-sm">
                    <Link href="/questionnaire" className="text-sm sm:text-sm font-bold text-muted-foreground hover:text-primary flex items-center gap-1.5 transition-colors group pl-1 sm:pl-2">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 pr-1">
                        ...
                        <div className="px-2 sm:px-3 py-1 bg-muted/30 rounded-lg border flex items-center justify-center">
                            <span className="text-xs sm:text-sm font-black tracking-widest text-muted-foreground">{currentIndex} / {totalCount}</span>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-wrap items-center gap-3">
                            <Badge variant="outline" className="px-2 py-0 font-extrabold bg-primary/10 text-primary border-primary/20 text-xs tracking-widest uppercase">
                            ...
                            {answer && (
                                <>
                                    ...
                                    <Badge className="px-2 py-0 font-black text-xs uppercase tracking-widest bg-primary text-primary-foreground border-transparent">
                        ...
                        <div className="space-y-10 col-span-4">
                            <form onSubmit={submit} className="space-y-10">
                                        ...
                                        {question.options.map((opt: any) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pr-4">
                                                    ...
                                                    <div className={`px-3 py-1.5 rounded-xl font-black text-sm min-w-[50px] text-center ${data.option_id == opt.id ? 'bg-primary text-white' : 'bg-muted text-muted-foreground group-hover:bg-muted-foreground/10'}`}>
                                                        {opt.score}
                                                    </div>
                                                </div>
                                            </label>
                                ...
                                <div className="space-y-6 pt-6 border-t font-semibold">
                                    <div className="flex flex-col gap-1">
                                        <Label className="text-xs font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">Upload Bukti Dokumen</Label>
                                        <div className="h-0.5 w-8 bg-primary/40 rounded-full ml-1" />
                                    </div>
                                    ...
                                    {answer?.evidence_submissions && answer.evidence_submissions.length > 0 && (
                                        <div className="flex flex-col gap-2 p-4 bg-muted/30 border border-muted-foreground/10 rounded-3xl animate-in fade-in">
                                            <div className="flex justify-between items-center px-1">
                                                <span className="text-xs font-black uppercase tracking-[0.2em] text-muted-foreground opacity-70">LAMPIRAN AKTIF</span>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-[250px] overflow-y-auto pr-1">
                                                {answer.evidence_submissions.map((ev: any) => (
                                                    ...
                                                    >
                                                        <span className="text-sm font-bold text-muted-foreground truncate flex-1 group-hover:text-primary transition-colors pl-1">
                                                            {ev.original_name}
                                                        </span>
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex flex-col gap-0.5">
                                                    ...
                                                    <span className="text-xs text-primary/70 font-black uppercase tracking-widest">Regulasi & Juknis</span>
                                                </div>
                                            </div>
