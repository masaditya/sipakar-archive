                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <Card className="border-none shadow-xl bg-gradient-to-br from-primary/10 to-transparent overflow-hidden relative group">
                        ...
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-black uppercase tracking-widest text-primary">Total Pelaksana</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-4xl font-black">{stats.users}</div>
                            <p className="text-sm text-muted-foreground font-bold mt-1 uppercase tracking-tighter opacity-70">User Terdaftar</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-none shadow-xl bg-gradient-to-br from-primary/5 to-transparent overflow-hidden relative group">
                        ...
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-black uppercase tracking-widest text-primary">Instansi</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-4xl font-black">{stats.organizations}</div>
                            <p className="text-sm text-muted-foreground font-bold mt-1 uppercase tracking-tighter opacity-70">Organisasi Aktif</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-none shadow-xl bg-gradient-to-br from-primary/10 to-transparent overflow-hidden relative group">
                        ...
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-black uppercase tracking-widest text-primary">Bank Soal</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-4xl font-black">{stats.questions}</div>
                            <p className="text-sm text-muted-foreground font-bold mt-1 uppercase tracking-tighter opacity-70">Butir Pertanyaan</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-none shadow-xl bg-gradient-to-br from-primary/5 to-transparent overflow-hidden relative group">
                        ...
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-black uppercase tracking-widest text-primary">Aspek</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-4xl font-black">{stats.aspects}</div>
                            <p className="text-sm text-muted-foreground font-bold mt-1 uppercase tracking-tighter opacity-70">Aspek Pengawasan</p>
                        </CardContent>
                    </Card>
                </div>
                    ...
                    <div className="p-5 border-b bg-muted/10 flex flex-col md:flex-row gap-4 items-center justify-between">
                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto">
                            <Select value={progressFilter} onValueChange={setProgressFilter}>
                                <SelectTrigger className="w-full md:w-[170px] rounded-xl text-sm font-bold h-10 border-muted-foreground/20 shadow-sm">
                                    <SelectValue placeholder="Semua Progres" />
                                </SelectTrigger>
                                <SelectContent className="rounded-xl border-none shadow-xl">
                                    <SelectItem value="all" className="text-sm font-bold">Semua Progres</SelectItem>
                                    <SelectItem value="complete" className="text-sm font-bold">Selesai (100%)</SelectItem>
                                    <SelectItem value="in-progress" className="text-sm font-bold">Sedang Berjalan</SelectItem>
                                    <SelectItem value="not-started" className="text-sm font-bold">Belum Mulai</SelectItem>
                                </SelectContent>
                            </Select>
                            
                            <Select value={sortValue} onValueChange={setSortValue}>
                                <SelectTrigger className="w-full md:w-[190px] rounded-xl text-sm font-bold h-10 border-muted-foreground/20 shadow-sm">
                                    <SelectValue placeholder="Urutkan" />
                                </SelectTrigger>
                                <SelectContent className="rounded-xl border-none shadow-xl">
                                    <SelectItem value="score-desc" className="text-sm font-bold">Skor Tertinggi</SelectItem>
                                    <SelectItem value="score-asc" className="text-sm font-bold">Skor Terendah</SelectItem>
                                    <SelectItem value="progress-desc" className="text-sm font-bold">Progres (Tinggi - Rendah)</SelectItem>
                                    <SelectItem value="progress-asc" className="text-sm font-bold">Progres (Rendah - Tinggi)</SelectItem>
                                    <SelectItem value="organization-asc" className="text-sm font-bold">Instansi (A - Z)</SelectItem>
                                    <SelectItem value="organization-desc" className="text-sm font-bold">Instansi (Z - A)</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </div>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-muted/50 border-none h-14">
                                            <TableHead className="pl-8 min-w-[180px] text-xs font-black uppercase tracking-widest text-muted-foreground">Pelaksana</TableHead>
                                            <TableHead className="min-w-[280px] text-xs font-black uppercase tracking-widest text-muted-foreground">Instansi / Dinas</TableHead>
                                            <TableHead className="min-w-[220px] text-xs font-black uppercase tracking-widest text-muted-foreground">Progress Pengisian</TableHead>
                                            <TableHead className="text-right sticky right-[100px] bg-muted/60 backdrop-blur-md z-20 shadow-[-4px_0_4px_-4px_rgba(0,0,0,0.1)] text-xs font-black uppercase tracking-widest text-muted-foreground">Skor Akhir</TableHead>
                                            <TableHead className="text-right sticky right-0 bg-muted/60 backdrop-blur-md z-20 w-[100px] pr-8 text-xs font-black uppercase tracking-widest text-muted-foreground">Opsi Review</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                            ...
                                            paginatedUsers.map((user: any) => (
                                                <TableRow key={user.id} className="hover:bg-primary/[0.03] group border-muted/10 transition-colors">
                                                    <TableCell className="pl-8 font-medium py-5">
                                                        ...
                                                        <div className="text-xs text-muted-foreground font-bold opacity-70 truncate max-w-[200px]" title={user.email}>{user.email}</div>
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="py-5 min-w-[240px]">
                                                        <div className="flex flex-col gap-2.5 pr-4">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="text-xs font-black w-9">{user.progress}%</span>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                                                                <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-primary/10 text-primary border border-primary/20">
                                                                    ...
                                                                    <span className="text-xs font-black uppercase tracking-wider">Final: {user.completed_progress}%</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell className="text-right sticky right-[100px] bg-background/98 backdrop-blur-sm group-hover:bg-primary/[0.01] z-10 shadow-[-4px_0_4px_-4px_rgba(0,0,0,0.1)] py-5">
                                                        <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-xl bg-orange-500/10 text-orange-600 font-black text-sm border border-orange-500/20 shadow-sm">
                                                            {user.score} pt
                                                        </div>
                                                    </TableCell>
                                                    <TableCell className="text-right sticky right-0 bg-background/98 backdrop-blur-sm group-hover:bg-primary/[0.01] z-10 pr-8 py-5">
                                                        <Link 
                                                            ...
                                                            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-foreground text-background text-xs font-black uppercase tracking-widest hover:bg-primary hover:text-white transition-all shadow-md hover:shadow-lg active:scale-95"
                                                        >
                            ...
                            <div className="p-5 border-t bg-muted/10 flex flex-col md:flex-row items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <Button 
                                        variant="outline" 
                                        size="sm" 
                                        className="h-9 px-4 text-sm font-bold rounded-xl bg-background shadow-sm hover:text-primary transition-colors" 
                                    ...
                                    <div className="px-3 text-sm font-bold text-muted-foreground flex items-center gap-1">
